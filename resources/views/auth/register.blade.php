                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('cadastrar') }}">
                            ...
                            <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="username" type="input" class="form-control" name="username" value="{{ old('username') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('cpf') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="cpf" type="input" class="form-control" name="cpf" value="{{ old('cpf') }}" required>
