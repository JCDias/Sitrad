		...
		<div class="col-md-12">
			<div class="box box-info">
				<div class="box-header with-border">
					<h3>Atribuir ou remover permissões à função: <b>{{ $nome_funcao }}</b></h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					...
					<div class="form-group">
						...
						<select class="form-control select2" name="permissoes[]" multiple="multiple" data-placeholder="Selecione as permissões." style="width: 100%; height: 100px;" required>
							@foreach($permissoes as $permissao)
							<option value="{{ $permissao['id'] }}" {{ $permissao['atributo'] }}>{{ $permissao['name'] }}</option>
							@endforeach
						</select>
					</div>
